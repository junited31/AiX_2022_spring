...
## 3. 본론
 ...
 ![GAN](https://user-images.githubusercontent.com/102155443/170975791-6fd07e2b-0771-4666-ac66-63ed4f4913b4.png)

 &nbsp;일반적인 GAN의 구조에서 판별기는 실제 데이터를 학습하여 실제 데이터를 진짜로 분류하도록, 생성기가 생성한 가짜 데이터를 가짜로 분류하도록 한다. 
