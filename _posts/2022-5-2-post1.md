...
## 1. 서론
 ...
 이번 SKT AI Fellowship에서 4기의 과제 List 중 하나로 딥러닝 기반 흑백 이미지 컬러화 기술 개발을 선정하면서, 이미지가 담고 있는 상황(전쟁, 해방, 시위)의 특성에 맞는 Adaptive Colorization 모델 개발에 관심이 생겼다.

![이미지 1](./images/image1.png)
