...
## 3. Methodology
 ...
 &nbsp; FCN(Fully Convolution Network)을 토대로 확장한 U-Net은 Pooling을 통해 feature map을 축소시켜 downsampling하는 encoder, Transpose convolution을 통해 축소시킨 feature map을 확장시켜 upsampling하는 decoder, 그리고 이 둘을 Concatenate를 통해 연결시키는 skip connection으로 구성되어 있다. Skip connection을 통해 네트워크 얕은 층에서 얻을 수 있는 fine, 국소적인 정보, 깊은 층에서 얻을 수 있는 global, 전역적인 정보를 모두 포함할 수 있다.
